  ...
  return (
    <View className="flex-1">
      ...
      <ScrollView className="flex-1">
        {/* Hero Section - Agora fora do container para ocupar largura total */}
        <View className="relative bg-barber-dark text-white w-full">
          <Image 
            source={require('../assets/capa.jpg')}
            style={{ width: '100%', height: 250 }} // Aumentei a altura para 250
            resizeMode="cover"
          />
          <View className="absolute inset-0 bg-black/30 flex items-center justify-center p-4">
            ...
            >
              ...
              <TouchableOpacity 
                ...
                className="border-2 hover:bg-yellow-400 border-white rounded-lg px-6 py-3" // Aumentei o padding
              >
        ...
        {/* Container principal para o restante do conteúdo */}
        ...
        {/* CTA Section - Agora fora do container para ocupar largura total */}
...
// Componente de FeatureCard ajustado
